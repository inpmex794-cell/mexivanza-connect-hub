...
const translations = {
  es: {
    ...
    "agents.contact_message": "¡Hola! Estoy interesado en servicios inmobiliarios en la región. ¿Puedes ayudarme?",
    "agents.whatsapp_message": "¡Hola! Necesito asistencia inmobiliaria.",
    "agents.contact_info": "Información de contacto no disponible",
    "agents.no_agents_region": "No se encontraron agentes verificados en la región seleccionada.",
    "agents.add_agent": "Agregar Agente",
    "agents.add_first": "Agregar Primer Agente",
    "agents.fetch_error": "Error al cargar agentes",
